...
hash ( const char *str,  size_t len)
{
  static unsigned short asso_values[] =
    {
       8, 31, 31, 31, 31, 31, 31, 31, 17, 15,
      31, 31, 14,  8,  9, 14,  7, 31, 31, 31,
      31, 31, 31, 31, 31, 31, 31, 31, 12, 31,
      31, 31, 31, 31, 31, 31, 18, 31, 31, 31,
      13, 31, 31, 31, 17, 31, 31, 31, 16, 31,
      31, 31, 15, 31, 31, 31, 14, 31, 31, 31,
      10, 31, 31, 31, 10, 31, 31, 31, 31, 31,
...
#line 49 "kobject_hash.gperf"
    {(char *)0x00000000200110c0, {0}, K_OBJ_THREAD, 0, { .thread_id = 7 }},
#line 43 "kobject_hash.gperf"
    {(char *)0x0000000020010d10, {0}, K_OBJ_THREAD, 0, { .thread_id = 3 }},
#line 44 "kobject_hash.gperf"
    {(char *)0x0000000020010da8, {0}, K_OBJ_THREAD, 0, { .thread_id = 2 }},
...
#line 46 "kobject_hash.gperf"
    {(char *)0x0000000020010ed8, {0}, K_OBJ_THREAD, 0, { .thread_id = 0 }},
#line 45 "kobject_hash.gperf"
    {(char *)0x0000000020010e40, {0}, K_OBJ_THREAD, 0, { .thread_id = 1 }},
#line 48 "kobject_hash.gperf"
    {(char *)0x0000000020011028, {0}, K_OBJ_THREAD, 0, { .thread_id = 5 }},
#line 51 "kobject_hash.gperf"
    {(char *)0x0000000020012800, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[1] }},
#line 55 "kobject_hash.gperf"
    {(char *)0x0000000020013800, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[5] }},
#line 54 "kobject_hash.gperf"
    {(char *)0x0000000020013400, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[4] }},
#line 53 "kobject_hash.gperf"
    {(char *)0x0000000020013000, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[3] }},
#line 52 "kobject_hash.gperf"
    {(char *)0x0000000020012c00, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[2] }},
#line 50 "kobject_hash.gperf"
    {(char *)0x0000000020012400, {0}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_data = &stack_data[0] }},
#line 47 "kobject_hash.gperf"
    {(char *)0x0000000020010f90, {0}, K_OBJ_THREAD, 0, { .thread_id = 6 }},
#line 42 "kobject_hash.gperf"
    {(char *)0x0000000020010c78, {0}, K_OBJ_THREAD, 0, { .thread_id = 4 }},
