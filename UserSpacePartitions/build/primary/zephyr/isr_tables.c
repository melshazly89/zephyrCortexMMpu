...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[98] = {
	...
	{(const void *)0x800d1ea, (ISR)0x8003a2d}, /* 6 */
	{(const void *)0x800d1e8, (ISR)0x8003a2d}, /* 7 */
	{(const void *)0x800d1e6, (ISR)0x8003a2d}, /* 8 */
	{(const void *)0x800d1e4, (ISR)0x8003a2d}, /* 9 */
	{(const void *)0x800d1e2, (ISR)0x8003a2d}, /* 10 */
	...
	{(const void *)0x800d1e0, (ISR)0x8003a2d}, /* 23 */
	...
	{(const void *)0x800d1de, (ISR)0x8003a2d}, /* 40 */
