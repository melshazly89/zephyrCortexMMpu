...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_DOMAIN_PARTITIONS, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COMMON_LIBC_MALLOC_ARENA_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXECUTE_XOR_WRITE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LINKER_USE_NO_RELAX, 1);
