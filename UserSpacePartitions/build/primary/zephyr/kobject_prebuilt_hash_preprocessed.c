...
hash (register const char *str, register size_t len)
{
  static unsigned char asso_values[] =
    {
      10, 30, 30, 30, 30, 30, 30, 30, 20, 12,
      15,  9, 15, 30, 30, 30, 13, 13, 13, 30,
      12, 30, 30, 30, 12, 30, 30, 30, 30, 30,
      30, 30, 11, 30, 30, 30, 12, 30, 30, 30,
       9, 30, 30, 30, 30, 30, 30, 30, 11, 30,
      30, 30, 10, 30, 30, 30, 10, 30, 30, 30,
...
#line 33 "kobject_prebuilt_hash.gperf"
    {"\370\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
...
#line 32 "kobject_prebuilt_hash.gperf"
    {"\330\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
...
#line 30 "kobject_prebuilt_hash.gperf"
    {"\230\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 23 "kobject_prebuilt_hash.gperf"
    {"\230\273\000\010", {0}, K_OBJ_DRIVER_RESET, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 29 "kobject_prebuilt_hash.gperf"
    {"x\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 22 "kobject_prebuilt_hash.gperf"
    {"x\273\000\010", {0}, K_OBJ_DRIVER_CLOCK_CONTROL, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 28 "kobject_prebuilt_hash.gperf"
    {"X\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 36 "kobject_prebuilt_hash.gperf"
    {"X\275\000\010", {0}, K_OBJ_DRIVER_UART, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
...
#line 35 "kobject_prebuilt_hash.gperf"
    {"8\275\000\010", {0}, K_OBJ_DRIVER_UART, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
...
#line 34 "kobject_prebuilt_hash.gperf"
    {"\030\275\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 31 "kobject_prebuilt_hash.gperf"
    {"\270\274\000\010", {0}, K_OBJ_DRIVER_GPIO, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 45 "kobject_prebuilt_hash.gperf"
    {"\330\020\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 4 }},
#line 44 "kobject_prebuilt_hash.gperf"
    {"\220\020\001 ", {0}, K_OBJ_TIMER, 0, { .unused = 0 }},
#line 43 "kobject_prebuilt_hash.gperf"
    {"\340\013\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 2 }},
#line 42 "kobject_prebuilt_hash.gperf"
    {"(\013\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 0 }},
...
#line 40 "kobject_prebuilt_hash.gperf"
    {"4\011\001 ", {0}, K_OBJ_SEM, 0 | K_OBJ_FLAG_INITIALIZED, { .unused = 0 }},
#line 39 "kobject_prebuilt_hash.gperf"
    {" \011\001 ", {0}, K_OBJ_MUTEX, 0 | K_OBJ_FLAG_INITIALIZED, { .unused = 0 }},
#line 48 "kobject_prebuilt_hash.gperf"
    {"$\024\001 ", {0}, K_OBJ_SEM, 0, { .unused = 0 }},
#line 47 "kobject_prebuilt_hash.gperf"
    {"`\022\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 5 }},
#line 46 "kobject_prebuilt_hash.gperf"
    {"\200\021\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 3 }},
#line 38 "kobject_prebuilt_hash.gperf"
    {"\014\011\001 ", {0}, K_OBJ_SEM, 0, { .unused = 0 }},
#line 41 "kobject_prebuilt_hash.gperf"
    {"\200\012\001 ", {0}, K_OBJ_THREAD, 0, { .thread_id = 1 }},
