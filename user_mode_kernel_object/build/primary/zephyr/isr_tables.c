...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[98] = {
	...
	{(const void *)0x800d2e5, (ISR)0x800399d}, /* 6 */
	{(const void *)0x800d2e3, (ISR)0x800399d}, /* 7 */
	{(const void *)0x800d2e1, (ISR)0x800399d}, /* 8 */
	{(const void *)0x800d2df, (ISR)0x800399d}, /* 9 */
	{(const void *)0x800d2dd, (ISR)0x800399d}, /* 10 */
	...
	{(const void *)0x800d2db, (ISR)0x800399d}, /* 23 */
	...
	{(const void *)0x800d2d9, (ISR)0x800399d}, /* 40 */
